...
const inclineWire = new Gpio(6, { mode: Gpio.OUTPUT, pullUpDown: Gpio.PUD_DOWN });
const declineWire = new Gpio(5, { mode: Gpio.OUTPUT, pullUpDown: Gpio.PUD_DOWN });
const inclineInfoWire = new Gpio(25, { mode: Gpio.INPUT, pullUpDown: Gpio.PUD_DOWN, edge: Gpio.RISING_EDGE });
const {
    performance
} = require('perf_hooks');
